...
describe('MockStellarService - Unit Tests', () => {
  ...
  describe('Wallet Creation', () => {
    test('should create a new wallet when valid keypair', async () => {
    ...
    test('should initialize wallet when zero balance', async () => {
      const wallet = await service.createWallet();
  ...
  describe('Testnet Funding', () => {
    ...
    test('should update wallet balance when funding', async () => {
      const wallet = await service.createWallet();
  ...
  describe('Donation Transactions', () => {
    ...
    test('should update balances when donation', async () => {
      const source = await service.createWallet();
      const destination = await service.createWallet();
    ...
    test('should reject donation when insufficient balance', async () => {
      const source = await service.createWallet();
      const destination = await service.createWallet();
    ...
    test('should reject donation when invalid source secret', async () => {
      const destination = await service.createWallet();
  ...
  describe('Transaction Details', () => {
    ...
    test('should format amounts when 7 decimal places', async () => {
      const source = await service.createWallet();
      const destination = await service.createWallet();
