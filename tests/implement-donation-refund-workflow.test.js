...
describe('POST /donations/:id/refund', () => {
  ...
  describe('Donation Status Validation', () => {
    test('should reject refund for pending donation', async () => {
      const donation = Transaction.create({
        amount: 100,
    ...
    test('should reject refund for submitted donation', async () => {
      const donation = Transaction.create({
        amount: 100,
  ...
  describe('Error Handling', () => {
    test('should throw NotFoundError for non-existent donation', async () => {
      await expect(
  ...
  describe('Audit Logging', () => {
    test('should create audit log entry for successful refund', async () => {
      const donation = Transaction.create({
        amount: 100,
        donor: 'GDONOR-AUDIT',
    ...
    test('should log refund with original and reverse transaction IDs', async () => {
  ...
  describe('Edge Cases', () => {
    test('should handle refund with no reason provided', async () => {
      const donation = Transaction.create({
        amount: 100,
    ...
    test('should create reverse transaction with REFUND memo', async () => {
      const donation = Transaction.create({
        amount: 100,
        donor: 'GDONOR-MEMO',
