...
describe('Wallet Analytics - Statistics Service Tests', () => {
  ...
  describe('Lifetime Analytics Calculation', () => {
    test('should calculate correct totals when wallet when sent and received transactions', () => {
    ...
    test('should calculate correct totals when wallet when only sent transactions', () => {
    ...
    test('should calculate correct totals when wallet when only received transactions', () => {
    ...
    test('should return zero totals when non-existent wallet', () => {
  ...
  describe('Transaction Details', () => {
    test('should include detailed information when sent transactions', () => {
      const analytics = StatsService.getWalletAnalytics('Alice');
