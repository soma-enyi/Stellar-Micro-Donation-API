...
describe('Account Funding Verification', () => {
  ...
  describe('isAccountFunded', () => {
    test('should return false when non-existent account', async () => {
    ...
    test('should return false when unfunded account', async () => {
    ...
    test('should return true when funded account', async () => {
      const wallet = await service.createWallet();
  ...
  describe('Donation to Unfunded Account', () => {
    ...
    test('should provide helpful error message when unfunded account', async () => {
      const source = await service.createWallet();
      const destination = await service.createWallet();
  ...
  describe('Edge Cases', () => {
    test('should handle account when minimal balance', async () => {
      const source = await service.createWallet();
      const destination = await service.createWallet();
    ...
    test('should reject account when exactly zero balance', async () => {
      const source = await service.createWallet();
      const destination = await service.createWallet();
