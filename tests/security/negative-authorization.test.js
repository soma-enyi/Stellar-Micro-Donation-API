...
describe('Negative Authorization Tests', () => {
  ...
  describe('Invalid API Keys', () => {
    test('should reject request when no API key header', async () => {
    ...
    test('should reject request when empty API key', async () => {
      app.use(requireApiKey);
      app.get('/test', (req, res) => res.json({ success: true }));
    ...
    test('should reject request when malformed API key', async () => {
      validateApiKey.mockResolvedValue(null);
      app.use(requireApiKey);
      app.get('/test', (req, res) => res.json({ success: true }));
    ...
    test('should reject request when expired API key', async () => {
      validateApiKey.mockResolvedValue(null);
      app.use(requireApiKey);
      app.get('/test', (req, res) => res.json({ success: true }));
    ...
    test('should reject request when revoked API key', async () => {
      validateApiKey.mockResolvedValue(null);
      app.use(requireApiKey);
      app.get('/test', (req, res) => res.json({ success: true }));
  ...
  describe('Error Response Standardization', () => {
    test('should return standardized error when missing API key', async () => {
      app.use(requireApiKey);
      app.get('/test', (req, res) => res.json({ success: true }));
    ...
    test('should return standardized error when invalid API key', async () => {
      validateApiKey.mockResolvedValue(null);
      app.use(requireApiKey);
      app.get('/test', (req, res) => res.json({ success: true }));
    ...
    test('should return standardized error when insufficient permissions', async () => {
      app.use(attachUserRole());
      app.use(checkPermission(PERMISSIONS.WALLETS_DELETE));
      app.delete('/test', (req, res) => res.json({ success: true }));
      addErrorHandler();
    ...
    test('should return clear error message when admin-only access', async () => {
      app.use(attachUserRole());
      app.use(requireAdmin());
      app.get('/test', (req, res) => res.json({ success: true }));
      addErrorHandler();
  ...
  describe('Edge Cases', () => {
    ...
    test('should reject API key when special characters', async () => {
      validateApiKey.mockResolvedValue(null);
      app.use(requireApiKey);
      app.get('/test', (req, res) => res.json({ success: true }));
