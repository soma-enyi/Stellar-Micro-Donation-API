...
describe('computeFingerprint', () => {
  describe('Basic Functionality', () => {
    ...
    test('should generate consistent fingerprints when identical requests', () => {
      const req1 = {
        method: 'POST',
        path: '/api/users',
    ...
    test('should generate different fingerprints when different methods', () => {
      const req1 = {
        method: 'POST',
        path: '/api/users',
        body: { name: 'John' }
    ...
    test('should generate different fingerprints when different paths', () => {
      const req1 = {
        method: 'POST',
        path: '/api/users',
        body: { name: 'John' }
    ...
    test('should generate different fingerprints when different bodies', () => {
      const req1 = {
        method: 'POST',
        path: '/api/users',
        body: { name: 'John' }
  ...
  describe('Empty and Missing Body Handling', () => {
    ...
    test('should generate same fingerprint when missing and empty string body', () => {
      const req1 = {
        method: 'GET',
        path: '/api/users'
        // body is undefined
    ...
    test('should generate same fingerprint when null and empty string body', () => {
      const req1 = {
        method: 'GET',
        path: '/api/users',
        body: null
  ...
  describe('Edge Cases', () => {
    ...
    test('should handle body when boolean values', () => {
      const req = {
        method: 'POST',
        path: '/api/settings',
    ...
    test('should handle body when numeric values', () => {
      const req = {
        method: 'POST',
