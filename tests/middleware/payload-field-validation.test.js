...
describe('Payload Field Validation Integration', () => {
  ...
  describe('POST /donations/send', () => {
    it('should accept valid payload when all allowed fields', async () => {
    ...
    it('should accept valid payload when subset of allowed fields', async () => {
      const response = await request(app)
        .post('/api/v1/donations/send')
        .send({
          senderId: '123',
    ...
    it('should reject payload when unknown field', async () => {
      const response = await request(app)
        .post('/api/v1/donations/send')
        .send({
          senderId: '123',
    ...
    it('should reject payload when multiple unknown fields', async () => {
      const response = await request(app)
        .post('/api/v1/donations/send')
        .send({
          senderId: '123',
    ...
    it('should reject payload when typo in field name', async () => {
      const response = await request(app)
        .post('/api/v1/donations/send')
        .send({
          senderId: '123',
