...
describe('Suspicious Pattern Detection', () => {
  ...
  describe('High Velocity Detection', () => {
    ...
    it('should reset velocity window when expiration', () => {
  ...
  describe('Identical Amount Pattern Detection', () => {
    ...
    it('should not alert when varied amounts', () => {
  ...
  describe('Recipient Diversity Detection', () => {
    ...
    it('should not alert when normal recipient count', () => {
  ...
  describe('Sequential Failure Detection', () => {
    ...
    it('should reset counter when time gap', () => {
    ...
    it('should reset failures when success', () => {
  ...
  describe('No False Positives', () => {
    it('should not alert when normal donation patterns', () => {
    ...
    it('should not alert when legitimate recipient diversity', () => {
    ...
    it('should not alert when isolated failures', () => {
