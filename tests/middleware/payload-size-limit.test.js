...
describe('Payload Size Limit Middleware', () => {
  ...
  describe('Content-Length header handling', () => {
    ...
    it('should validate based when Content-Length header', async () => {
  ...
  describe('Different content types', () => {
    ...
    it('should apply text limit when text/plain content', async () => {
    ...
    it('should apply raw limit when octet-stream content', async () => {
