...
describe('Network Timeout and Service Unavailability Tests', () => {
  ...
  describe('Network Timeout Scenarios', () => {
    test('should timeout when slow balance query', async () => {
    ...
    test('should timeout when slow transaction submission', async () => {
    ...
    test('should timeout when slow transaction history query', async () => {
  ...
  describe('Retry Logic Scenarios', () => {
    test('should not retry when permanent errors', async () => {
      let attempts = 0;
  ...
  describe('Circuit Breaker Scenarios', () => {
    test('should open circuit when consecutive failures', async () => {
  ...
  describe('Error Message Clarity', () => {
    test('should provide clear error message when network timeout', async () => {
      if (stellarService.setNetworkDelay) {
        stellarService.setNetworkDelay(10000);
    ...
    test('should provide clear error message when service unavailable', async () => {
      if (stellarService.setServiceAvailable) {
        stellarService.setServiceAvailable(false);
