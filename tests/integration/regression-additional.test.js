...
describe('Regression Tests - Additional Recent Features', () => {
  ...
  describe('Transaction Sync Service', () => {
    it('should initialize when default Horizon URL', () => {
      const service = new TransactionSyncService();
      expect(service.server).toBeDefined();
    });

    it('should initialize when custom Horizon URL', () => {
    ...
    it('should fallback to source when no destination', () => {
      const service = new TransactionSyncService();
      const tx = { 
        source_account: 'GABC123',
        operations: [] 
  ...
  describe('Input Sanitization', () => {
    ...
    it('should sanitize memo when 28 byte limit', () => {
  ...
  describe('Memo Validation', () => {
    ...
    it('should reject memo when null bytes', () => {
    ...
    it('should check when memo is empty', () => {
