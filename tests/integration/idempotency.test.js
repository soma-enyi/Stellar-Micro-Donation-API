...
describe('Idempotency Integration - API Endpoint Tests', () => {
  ...
  describe('POST /donations - Idempotency', () => {
    ...
    it('should process request when valid idempotency key', async () => {
    ...
    it('should return cached response when duplicate idempotency key', async () => {
    ...
    it('should detect duplicate request when different idempotency key', async () => {
    ...
    it('should allow different requests when different idempotency keys', async () => {
  ...
  describe('POST /donations/send - Idempotency', () => {
    it('should require idempotency key when send endpoint', async () => {
      const response = await request(app)
    ...
    it('should prevent duplicate send when same idempotency key', async () => {
  ...
  describe('Concurrent Requests', () => {
    it('should handle concurrent requests when same idempotency key', async () => {
