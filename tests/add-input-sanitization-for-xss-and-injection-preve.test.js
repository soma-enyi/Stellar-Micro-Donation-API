...
describe('Input Sanitization - XSS and Injection Prevention', () => {
  ...
  describe('Unicode Normalization', () => {
    ...
    test('should prevent homograph attacks with lookalike characters', () => {
  ...
  describe('Field-Specific Sanitization', () => {
    describe('sanitizeMemo', () => {
      ...
      test('should handle memo with null bytes', () => {
  ...
  describe('Request Body Sanitization', () => {
    test('should sanitize request body with field types', () => {
      const body = {
    ...
    test('should use default text sanitization for unknown types', () => {
      const body = {
  ...
  describe('Edge Cases and Boundary Conditions', () => {
    ...
    test('should handle inputs with only control characters', () => {
      const input = '\x00\x01\x02\x03\x04\x05';
      const result = sanitizeText(input);
      expect(result).toBe('');
    });

    test('should handle inputs with mixed encodings', () => {
  ...
  describe('Performance and Stress Tests', () => {
    test('should handle sanitization efficiently on large strings', () => {
