...
describe('Donation Amount Boundary Tests', () => {
  ...
  describe('Decimal Precision Boundaries', () => {
    ...
    it('should accept minimum when 7 decimals (0.0100000)', () => {
      const result = validator.validateAmount(0.0100000);
      expect(result.valid).toBe(true);
    });

    it('should accept maximum when 7 decimals (10000.0000000)', () => {
  ...
  describe('Range Check Utility', () => {
    it('should return true when amount within range', () => {
      expect(validator.isValidRange(100)).toBe(true);
    });

    it('should return true when minimum amount', () => {
      expect(validator.isValidRange(0.01)).toBe(true);
    });

    it('should return true when maximum amount', () => {
      expect(validator.isValidRange(10000)).toBe(true);
    });

    it('should return false when amount below minimum', () => {
      expect(validator.isValidRange(0.009)).toBe(false);
    });

    it('should return false when amount above maximum', () => {
  ...
  describe('Get Limits', () => {
    ...
    it('should return updated limits when change', () => {
  ...
  describe('Real-World Donation Scenarios', () => {
    ...
    it('should prevent exceeding daily limit when large donation', () => {
