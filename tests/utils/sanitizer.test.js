...
describe('Sanitizer Utility', () => {
  ...
  describe('sanitizeMemo', () => {
    test('should sanitize memo when 28 byte limit', () => {
  ...
  describe('sanitizeForLogging', () => {
    test('should sanitize string values when logging', () => {
      expect(sanitizeForLogging('hello\nworld')).toBe('helloworld');
      expect(sanitizeForLogging('test\x00value')).toBe('testvalue');
    });

    test('should sanitize objects when logging', () => {
      const obj = {
        name: 'test\nvalue',
        memo: 'hello\x00world'
      };
    ...
    test('should sanitize arrays when logging', () => {
  ...
  describe('sanitizeRequestBody', () => {
    test('should sanitize request body when field config', () => {
      const body = {
        memo: 'test\nmemo',
        label: '  My Label  ',
        amount: 100
    ...
    test('should use default text sanitization when unconfigured fields', () => {
      const body = {
        customField: 'test\nvalue'
      };
