...
describe('Permission System - Unit Tests', () => {
  ...
  describe('Permission Retrieval by Role', () => {
    test('should return all permissions when admin role', () => {
      const permissions = getPermissionsByRole(ROLES.ADMIN);
      expect(permissions).toContain('*');
    });

    test('should return limited permissions when user role', () => {
    ...
    test('should return read-only permissions when guest role', () => {
    ...
    test('should return empty array when non-existent role', () => {
