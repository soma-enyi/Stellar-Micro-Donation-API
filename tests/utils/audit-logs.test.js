...
describe('AuditLogService', () => {
  ...
  describe('log()', () => {
    it('should create audit log entry when all required fields', async () => {
    ...
    it('should generate unique integrity hash when each entry', async () => {
  ...
  describe('query()', () => {
    ...
    it('should support pagination when limit and offset', async () => {
