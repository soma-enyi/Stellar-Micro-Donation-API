...
describe('Memo Integration - End-to-End Tests', () => {
  ...
  describe('Donation with Memo', () => {
    test('should create donation when valid memo text', async () => {
      // Create wallets
    ...
    test('should create donation when empty memo', async () => {
      const donor = await stellarService.createWallet();
      const recipient = await stellarService.createWallet();
    ...
    test('should handle memo when special characters', async () => {
      const donor = await stellarService.createWallet();
      const recipient = await stellarService.createWallet();
    ...
    test('should retrieve transaction history when memos', async () => {
      const donor = await stellarService.createWallet();
      const recipient = await stellarService.createWallet();
  ...
  describe('Memo Edge Cases', () => {
    ...
    test('should handle memo when whitespace', async () => {
      const donor = await stellarService.createWallet();
      const recipient = await stellarService.createWallet();
