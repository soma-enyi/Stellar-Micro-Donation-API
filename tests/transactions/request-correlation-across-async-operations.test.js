...
describe('Request Correlation Context Propagation (Issue #382)', () => {
  ...
  describe('Core Correlation Context Management', () => {
    ...
    test('should create correlation context when required fields', () => {
    ...
    test('should create background context when isBackgroundTask flag', () => {
  ...
  describe('Background Task Context', () => {
    ...
    test('should execute background task when isolated context', async () => {
      const parentContext = createCorrelationContext({
        requestId: 'req-123',
        operationType: 'http_request'
      });
    ...
    test('should mark background task when correct type', async () => {
  ...
  describe('Correlation Headers Generation', () => {
    ...
    test('should generate headers when trace ID propagation', async () => {
      const parentContext = createCorrelationContext({
        requestId: 'req-123'
      });
      setCorrelationContext(parentContext);
  ...
  describe('WebhookService Integration', () => {
    ...
    test('should deliver webhook event when correlation context', async () => {
      const parentContext = createCorrelationContext({
        requestId: 'req-123',
        operationType: 'http_request'
      });
  ...
  describe('Context Summary and Status', () => {
    ...
    test('should indicate child context when parent', async () => {
      const parentContext = createCorrelationContext({
        requestId: 'req-123'
      });
      setCorrelationContext(parentContext);
  ...
  describe('Performance and Memory', () => {
    ...
    test('should not create context memory leaks when many operations', async () => {
      const parentContext = createCorrelationContext({
        requestId: 'req-123'
      });
      setCorrelationContext(parentContext);
