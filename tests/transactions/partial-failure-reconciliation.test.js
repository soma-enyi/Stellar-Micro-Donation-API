...
describe('Partial Failure Scenarios - Reconciliation', () => {
  ...
  describe('Scenario 1: Verification Succeeds, Update Fails', () => {
    test('should handle state update failure when successful verification', async () => {
  ...
  describe('Scenario 2: Verification Failures', () => {
    ...
    test('should handle transaction not found when network', async () => {
      const tx = Transaction.create({
        id: 'tx-recon-006',
        amount: 100,
        donor: 'GDONOR222',
  ...
  describe('Scenario 3: Reconciliation Service State', () => {
    ...
    test('should reset in-progress flag when failure', async () => {
  ...
  describe('Scenario 8: Error Recovery', () => {
    test('should continue reconciliation when individual transaction error', async () => {
