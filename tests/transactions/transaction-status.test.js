...
describe('Transaction Status Management', () => {
  ...
  describe('Transaction Creation with Status', () => {
    test('should create transaction when pending status by default', () => {
    ...
    test('should create transaction when specified status', () => {
      const transaction = Transaction.create({
        amount: 100,
        donor: 'Alice',
        recipient: 'Bob',
    ...
    test('should create transaction when Stellar data', () => {
      const transaction = Transaction.create({
        amount: 100,
        donor: 'Alice',
        recipient: 'Bob',
  ...
  describe('Status Updates', () => {
    ...
    test('should update status when Stellar transaction data', () => {
      const transaction = Transaction.create({
        amount: 100,
        donor: 'Alice',
        recipient: 'Bob',
    ...
    test('should throw error when non-existent transaction', () => {
      expect(() => {
  ...
  describe('Query by Status', () => {
    ...
    test('should return empty array when status when no transactions', () => {
  ...
  describe('Query by Stellar Transaction ID', () => {
    ...
    test('should return undefined when non-existent Stellar TX ID', () => {
  ...
  describe('Integration with MockStellarService', () => {
    ...
    test('should create transaction and update when Stellar confirmation', async () => {
