...
describe('Failure Scenarios - Comprehensive Error Tests', () => {
  ...
  describe('Memo Validation Errors', () => {
    ...
    test('should reject memo when null bytes', async () => {
      const donor = await stellarService.createWallet();
      const recipient = await stellarService.createWallet();
      await stellarService.fundTestnetWallet(donor.publicKey);
  ...
  describe('Transaction Validation Errors', () => {
    test('should reject transaction when missing required fields', async () => {
      await expect(
        stellarService.sendDonation({})
      ).rejects.toThrow();
    });

    test('should reject transaction when only source', async () => {
      const donor = await stellarService.createWallet();
    ...
    test('should reject transaction when only destination', async () => {
      const recipient = await stellarService.createWallet();
  ...
  describe('Concurrent Transaction Errors', () => {
    test('should handle race condition when insufficient funds', async () => {
      const donor = await stellarService.createWallet();
  ...
  describe('Database Operation Errors', () => {
    ...
    test('should handle transaction lookup when invalid ID', () => {
  ...
  describe('Stream Connection Errors', () => {
    ...
    test('should handle stream when null callback', () => {
  ...
  describe('Balance Query Errors', () => {
    test('should handle balance query when unfunded account', async () => {
      const wallet = await stellarService.createWallet();
    ...
    test('should handle balance query when network error simulation', async () => {
  ...
  describe('Transaction History Errors', () => {
    test('should handle history query when account when no transactions', async () => {
      const wallet = await stellarService.createWallet();
    ...
    test('should handle history query when invalid limit', async () => {
      const wallet = await stellarService.createWallet();
    ...
    test('should handle history query when zero limit', async () => {
      const wallet = await stellarService.createWallet();
  ...
  describe('Wallet Creation Errors', () => {
    test('should handle wallet creation when invalid parameters', async () => {
  ...
  describe('Error Recovery and Retry', () => {
    test('should not retry when invalid account error', async () => {
      let attempts = 0;
