...
describe('Recurring Donation Scheduler - Resilience Tests', () => {
  ...
  describe('Retry Mechanism with Exponential Backoff', () => {
    ...
    test('should fail permanently when maxRetries attempts exhausted', async () => {
      const schedule = {
        id: 1,
        donorId: 1,
        recipientId: 2,
  ...
  describe('Concurrent Execution Prevention and Deduplication', () => {
    ...
    test('should prevent duplicate execution when recently executed', async () => {
    ...
    test('should execute when last execution was more than 5 minutes ago', async () => {
    ...
    test('should remove schedule from executing set when completion', async () => {
      const schedule = {
        id: 1,
        donorId: 1,
        recipientId: 2,
    ...
    test('should remove schedule from executing set even when failure', async () => {
      const schedule = {
        id: 1,
        donorId: 1,
        recipientId: 2,
  ...
  describe('Execution Logging and Audit Trail', () => {
    test('should log successful execution when transaction hash', async () => {
      const schedule = {
        id: 1,
        donorId: 1,
        recipientId: 2,
    ...
    test('should log failed execution when error details', async () => {
      const schedule = {
        id: 1,
        donorId: 1,
        recipientId: 2,
    ...
    test('should create logs table when it does not exist', async () => {
      const schedule = {
        id: 1,
        donorId: 1,
        recipientId: 2,
  ...
  describe('Backoff Calculation with Jitter', () => {
    test('should calculate exponential backoff when proper timing', () => {
  ...
  describe('Status Monitoring and Reporting', () => {
    test('should return accurate scheduler status when metrics', () => {
      scheduler.isRunning = true;
      scheduler.executingSchedules.add(1);
    ...
    test('should get execution logs when a schedule', async () => {
      const logs = [
