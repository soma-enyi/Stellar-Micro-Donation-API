...
describe('TrackingStore', () => {
  ...
  describe('record()', () => {
    test('should record a fingerprint when timestamp', () => {
    ...
    test('should record multiple timestamps when same fingerprint', () => {
      const fingerprint = 'abc123';
  ...
  describe('getCount()', () => {
    test('should return 0 when non-existent fingerprint', () => {
      const count = store.getCount('nonexistent', 60000);
      expect(count).toBe(0);
    });

    test('should return correct count when fingerprint within window', () => {
      const fingerprint = 'abc123';
      const now = Date.now();
  ...
  describe('getTimestamps()', () => {
    test('should return empty array when non-existent fingerprint', () => {
  ...
  describe('cleanup()', () => {
    ...
    test('should not remove fingerprints when recent timestamps', () => {
      const fingerprint = 'abc123';
      const now = Date.now();
  ...
  describe('getStats()', () => {
    test('should return empty stats when empty store', () => {
      const stats = store.getStats();
    ...
    test('should return correct stats when single fingerprint', () => {
      const fingerprint = 'abc123';
      const ts1 = 1000;
      const ts2 = 2000;
      const ts3 = 3000;
    ...
    test('should return correct stats when multiple fingerprints', () => {
    ...
    test('should work when empty config object', () => {
      store.record('fp1', 1000);
