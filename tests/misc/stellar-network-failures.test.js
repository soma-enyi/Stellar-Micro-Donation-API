...
describe('Stellar Network Failure Simulations', () => {
  ...
  describe('Timeout Failures', () => {
    test('should handle timeout when balance query', async () => {
    ...
    test('should handle timeout when transaction submission', async () => {
  ...
  describe('Service Unavailable Failures', () => {
    ...
    test('should suggest longer retry delay when service unavailable', async () => {
      const wallet = await stellarService.createWallet();
  ...
  describe('Rate Limiting Failures', () => {
    ...
    test('should suggest long retry delay when rate limit', async () => {
      const wallet = await stellarService.createWallet();
  ...
  describe('Consecutive Failure Scenarios', () => {
    ...
    test('should auto-recover when max consecutive failures', async () => {
      const wallet = await stellarService.createWallet();
      await stellarService.fundTestnetWallet(wallet.publicKey);
  ...
  describe('Error Message Quality', () => {
    test('should provide clear error messages when all failure types', async () => {
      const wallet = await stellarService.createWallet();
