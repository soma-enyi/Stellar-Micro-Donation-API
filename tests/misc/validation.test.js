...
describe('Validation Utilities - Unit Tests', () => {
  describe('Stellar Public Key Validation', () => {
    ...
    test('should reject key when wrong length', () => {
      const invalidKey = 'GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX';
      expect(isValidStellarPublicKey(invalidKey)).toBe(false);
    });

    test('should reject key when invalid characters', () => {
  ...
  describe('Date Range Validation', () => {
    test('should accept valid date range when start before end', () => {
    ...
    test('should reject start date when end date', () => {
  ...
  describe('String Sanitization', () => {
    ...
    test('should return empty string when non-string input', () => {
  ...
  describe('transactionExists', () => {
    ...
    test('should return false when null transaction ID', () => {
      expect(transactionExists(null)).toBe(false);
    });

    test('should return false when undefined transaction ID', () => {
      expect(transactionExists(undefined)).toBe(false);
    });

    test('should return false when empty string transaction ID', () => {
      expect(transactionExists('')).toBe(false);
    });

    test('should return false when zero transaction ID', () => {
      Transaction.getById.mockReturnValue(null);
