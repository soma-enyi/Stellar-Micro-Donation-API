...
describe('Unknown Field Error Format', () => {
  ...
  describe('Real-world error scenarios', () => {
    it('should format error when donation endpoint when typo', () => {
    ...
    it('should format error when wallet endpoint when extra field', () => {
    ...
    it('should format error when API key endpoint when malicious field', () => {
