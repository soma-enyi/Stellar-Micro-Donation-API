...
describe('Idempotency Service - Unit Tests', () => {
  ...
  describe('Idempotency Key Validation', () => {
    ...
    it('should reject key when invalid characters', () => {
  ...
  describe('Request Hash Generation', () => {
    it('should generate consistent hash when same data', () => {
    ...
    it('should generate different hash when different data', () => {
  ...
  describe('Storage and Retrieval', () => {
    ...
    it('should return null when non-existent key', async () => {
  ...
  describe('Record Deletion', () => {
    ...
    it('should return false when non-existent key', async () => {
