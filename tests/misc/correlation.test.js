...
describe('Correlation ID Propagation', () => {
  ...
  describe('Correlation Context Management', () => {
    test('should create correlation context when default values', () => {
    ...
    test('should create correlation context when custom values', () => {
      const customContext = {
    ...
    test('should create async context when parent correlation', () => {
  ...
  describe('Context Execution Wrappers', () => {
    test('should execute function when correlation context', () => {
    ...
    test('should execute async function when correlation context', async () => {
    ...
    test('should execute background function when correlation context', async () => {
  ...
  describe('Async Context Propagation', () => {
    ...
    test('should handle concurrent async operations when separate contexts', async () => {
  ...
  describe('Background Task Context', () => {
    ...
    test('should not interfere when request contexts', async () => {
  ...
  describe('Performance Considerations', () => {
    ...
    test('should have minimal memory overhead when context storage', () => {
